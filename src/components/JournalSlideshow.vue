<template>
	<section class="journal">
		<h2 class="journal__heading">Journal</h2>
		...
		<div
			...
			<div class="slideshow__controls">
				<button
					...
					:key="testIndex"
					:aria-label=" testIndex === 1 ? 'previous slide' : 'next slide'"
					:class="{
			...
			<div
				class="slideshow__titles"
				:class="{ 'slideshow__titles--hide': !hover }"
			>
				<div>
			...
			<figure>
				<img class="slideshow__images" :src="imageLink" :alt="journalData[journalIndex].alt"/>
			</figure>
